...
{
CyTerm Project.
DefFont created by Shawn Rapp

This is actually a DOS ROM font dumped to bin and converted to
a pascal array.  Decided to compile it in to the code since
i figured having all the rom fonts seperate files would be bad.
}
...
const
  fontsize = 4096;
  defFontImage : array[1..4096] of byte = (
